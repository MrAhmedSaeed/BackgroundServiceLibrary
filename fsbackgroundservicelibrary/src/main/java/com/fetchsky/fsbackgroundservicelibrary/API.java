...
//            }
        ...
        Log.i("TestGPS getAuthToken", deviceToken);
        return deviceToken;
        // Set token in API header
    }

    private  void setAuthToken(String token) {
        Log.i("TestGPS setAuthToken", token);
        deviceToken = token;
        // Set token in API header
...
//        }
    ...
    public void getDeviceToken(String uuid, final HashMap locationData){
        Log.i("TestGPS Token befor", locationData.toString());
...
//        params.put("uuid", uuid);
    ...
    public void registerDeviceLocation(HashMap locationData) {
        ...
        Log.i("TestGPS offlineLocation", toString().valueOf(offlineLocation.size()));
        while(!offlineLocation.isEmpty()){
            Log.i("TestGPS offline work", locationData.toString());
